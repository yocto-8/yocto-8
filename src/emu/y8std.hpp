...
static constexpr std::array<NumericGlobal, 26> y8_numeric_globals{{
	...
	// patterns
	{u8"█", LuaFix16::from_fix16(fix16_t(0x0000'8000))},
	{u8"▒", LuaFix16::from_fix16(fix16_t(0x5A5A'8000))},
	{u8"░", LuaFix16::from_fix16(fix16_t(0x7D7D'8000))},
	{u8"🐱", LuaFix16::from_fix16(fix16_t(0x511F'8000))},
	{u8"▥", LuaFix16::from_fix16(fix16_t(0x5555'8000))},
	{u8"▤", LuaFix16::from_fix16(fix16_t(0x0F0F'8000))},
	{u8"✽", LuaFix16::from_fix16(fix16_t(0xB81D'8000))},
	{u8"●", LuaFix16::from_fix16(fix16_t(0xF99F'8000))},
	{u8"♥", LuaFix16::from_fix16(fix16_t(0x51BF'8000))},
	{u8"☉", LuaFix16::from_fix16(fix16_t(0xB5BF'8000))},
	{u8"웃", LuaFix16::from_fix16(fix16_t(0x999F'8000))},
	{u8"⌂", LuaFix16::from_fix16(fix16_t(0xB11F'8000))},
	{u8"😐", LuaFix16::from_fix16(fix16_t(0xA0E0'8000))},
	{u8"♪", LuaFix16::from_fix16(fix16_t(0x9B3F'8000))},
	{u8"◆", LuaFix16::from_fix16(fix16_t(0xB1BF'8000))},
	{u8"…", LuaFix16::from_fix16(fix16_t(0xF5FF'8000))},
	{u8"★", LuaFix16::from_fix16(fix16_t(0xB15F'8000))},
	{u8"⧗", LuaFix16::from_fix16(fix16_t(0x1B1F'8000))},
	{u8"ˇ", LuaFix16::from_fix16(fix16_t(0xF5BF'8000))},
	{u8"∧", LuaFix16::from_fix16(fix16_t(0x7ADF'8000))},
}};
