...
printh("hex fixed-point checks with negative, without all letters")
printh(tostr(-0xAD.EF))
printh(tostr(-0xAD.EF, true))
printh(tostr(-0xAD.EF, 0b01))
printh(tostr(-0xAD.EF, 0b10))
...
printh("hex fixed-point display to test binary literals")
printh(tostr(0b010101.010100))
printh(tostr(0b010101.010100, true))
printh(tostr(0b010101.010100, 0b01))
printh(tostr(0b010101.010100, 0b10))
printh(tostr(0b010101.010100, 0b11))

printh("hex fixed-point display to test binary literals (with negative)")
printh(tostr(-0b010101.010100))
printh(tostr(-0b010101.010100, true))
printh(tostr(-0b010101.010100, 0b01))
printh(tostr(-0b010101.010100, 0b10))
...
printh("hex fixed-point display to test binary literals without decimals")
printh(tostr(0b010101))
printh(tostr(0b010101, true))
printh(tostr(0b010101, 0b01))
printh(tostr(0b010101, 0b10))
printh(tostr(0b010101, 0b11))

printh("hex fixed-point display to test overflow like situation")
printh(tostr(0b1111111111111111.1111111111111111))
printh(tostr(0b1111111111111111.1111111111111111, true))
printh(tostr(0b1111111111111111.1111111111111111, 0b01))
printh(tostr(0b1111111111111111.1111111111111111, 0b10))
printh(tostr(0b1111111111111111.1111111111111111, 0b11))
